...
export const SITE = "https://Smiles93.github.io";
...
export const SITE_TITLE = "tils + tales";

// will be used in the meta tags (and for example shown in search results)
export const SITE_DESCRIPTION = "today I learned...";
...
export const SOCIAL_LINKS: {
  ...
  SHOW_RSS: true,
  GITHUB_URL: "https://github.com/Smiles93",
  EMAIL: "joeltan93@gmail.com",
};
